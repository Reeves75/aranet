...
Quick one-line reading with colored CO₂ status indicator.
...
Aranet4 17C3C: 847 ppm [GREEN] 22.4°C 45% 1013 hPa
```
...
|--------|---------|-------------|
| `-d, --device <ADDRESS>` | auto-detect | Device address (MAC or UUID) |
| `-i, --interval <SECONDS>` | device interval | Polling interval in seconds |
...
Watching Aranet4 17C3C (Ctrl+C to stop)...

[10:00:00] CO₂: 847 ppm [GREEN] 22.4°C 45% 1013 hPa
[10:05:00] CO₂: 823 ppm [GREEN] 22.5°C 44% 1013 hPa
[10:10:00] CO₂: 891 ppm [GREEN] 22.3°C 45% 1012 hPa
```
